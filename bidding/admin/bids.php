...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<!-- Table Panel -->
			<div class="col-md-12">
				<div class="card" style="background-color:mediumspringgreen">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<?php else: ?>
										<span class="badge badge-success">Win in Bidding</span>
										<?php endif; ?>
										<?php endif; ?>
									...
									<td>
										<button class="btn btn-primary btn-sm view_user" type="button" data-id ='<?php echo $row['user_id'] ?>'>View Vendor Details</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
